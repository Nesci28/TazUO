...
public class ScriptEditorWindow : MyraControl
{
    ...
    private void Build(string content)
    {
        ...
        _lines = new MyraInputBox
        {
            ...
            Background = MyraStyle.SurfaceInputBackgroundBrush,
        ...
        var codeRow = new MyraHorizontalStackPanel { Spacing = 0 };
        codeRow.Widgets.Add(_lines);
        codeRow.Widgets.Add(_editor);

        _scrollViewer = new MyraScrollViewer { Content = codeRow, Height = 500 };
