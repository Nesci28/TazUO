...
public class MyraControl : IGui
{
    ...
    /// <summary>Forwards top-level keyboard input and transient iOS backspace events.</summary>
    public virtual void InvokeKeyDown(SDL.SDL_Keycode key, SDL.SDL_Keymod mod)
    {
#if TAZUO_IOS
