...
namespace ClassicUO.Game.UI.Gumps
{
    public partial class TopBarGump : Gump
    {
        ...
        private TopBarGump(World world) : base(world, 0, 0)
        {
            ...
            {
                smallWidth = gumpInfo.LogicalWidth;
            }
            ...
            if (gumpInfo.Texture != null)
            {
                largeWidth = gumpInfo.LogicalWidth;
            }
            ...
            submenu.Add(new ContextMenuItemEntry(TazLang.Get("dualbox_title", "Dual Box"), () => DualBoxGump.Show(World)));
