...
namespace ClassicUO.LegionScripting
{
    ...
    public class LegionAPI : IDisposable
    {
        ...
        public ApiCombatDpsSnapshot GetCombatDps(uint serial = 0) => OnMain(() =>
            ApiCombatDpsSnapshot.FromSnapshot(
                serial == 0
                    ? World.CombatDamageTracker.GetActiveSnapshot()
        ...
        public ApiGameObject GetTile(int x, int y) => OnMain(() => World?.Map == null ? null : WrapGameObject(World.Map.GetTile(x, y)));
